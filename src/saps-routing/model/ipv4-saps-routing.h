...
#ifndef IPV4_SAPS_ROUTING_H
#define IPV4_SAPS_ROUTING_H
...
enum SapsRoutingMode
{
    DEST_BASED = 0,
    FLOW_BASED
};

class Ipv4SapsRouting : public Ipv4RoutingProtocol
{
